---
title: 'Riot.js で Tour of Heroes を試す - Chapter2 ヒーローエディター'
emoji: '📝'
...
以上で Chapter2「ヒーローエディタ」は完了です．何かわからないことがあれば，遠慮なくコメントしてください！可能な限りご説明させていただきます！

では，[Chapter3「リストの表示」](https://zenn.dev/kkeeth/articles/riotjs_tour_of_hero_03)に続きます．
